...
void desenhaCabecalho()
{
    Serial.println(" ");
    Serial.println(" "); 
    Serial.println(" ---  Fortaleza do Dado Sagrado ---"); 
    Serial.println(" "); 
    Serial.println(" "); 
}
...
void loop()
{
  ...
  for(int r = 0; r < qtdRodadas; r++)
  {
    ...
    int numeroEscolhido = random(1, 7);

    Serial.print("conferindo o numero");

    desenhaPontinhos();

    Serial.println("seu palpite: " + String(palpite));
    Serial.println("numeroescolhido: " + String(numeroEscolhido)); 
    Serial.println();

    vetpalpites[r] = palpite; 
    vetResultados[r] = numeroEscolhido; 
